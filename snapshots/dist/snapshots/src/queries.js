...
exports.getAllUsersQuery = client_1.gql `
  query allAccounts(
    $lastId: String!
    $timestamp: BigInt!
    $excluded: [String]
...
`;
exports.userActivityQuery = client_1.gql `
...
`;
exports.allMarketsQuery = client_1.gql `
...
`;
exports.allTransactionsPerUserQuery = client_1.gql `
...
`;
exports.getTradeVolumePerUserQuery = client_1.gql `
...
`;
exports.getFeesPaidPerUserQuery = client_1.gql `
  query totalTradeVolume(
    $lastId: String!
    $user: String!
...
`;
exports.getUsersWhoPaidFeesInEpochQuery = client_1.gql `
...
`;
exports.getFixedProductMarketMakerQuery = client_1.gql `
...
`;
exports.firstLiquidityAddedQuery = client_1.gql `
...
`;
exports.marketResolutionTxnQuery = client_1.gql `
...
`;
exports.getTradeVolumePerUserPerMarketQuery = client_1.gql `
  query totalTradeVolume(
    $lastId: String!
    $user: String!
    $timestamp: BigInt!
